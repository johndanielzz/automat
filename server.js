...
function buildMatAiSystemPrompt(knowledge, query, hasImage) {
    ...
    return [
        ...
        "- If the user uploads a close photo of a part, try to identify the likely part or component family, explain its function, common failure symptoms, and what should be checked before replacement.",
    ...
    app.use(helmet({
        contentSecurityPolicy: {
            directives: {
                ...
                connectSrc   : ["'self'", "https://*.firebaseio.com", "https://*.googleapis.com", "https://firebasestorage.googleapis.com", "https://fonts.googleapis.com", "https://fonts.gstatic.com", "wss://*.firebaseio.com"],
                frameSrc     : ["'none'"],
                objectSrc    : ["'none'"],
